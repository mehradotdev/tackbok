...
export const ar: Translations = {
  ...
  'Deleting journal everywhere…': 'جارٍ حذف اليوميات من كل مكان…',
  ...
  'Finish deleting this journal?': 'هل تريد إكمال حذف هذه اليوميات؟',
  'Cloud deletion is already recorded. Erase the remaining journal data from this device.': 'تم تسجيل الحذف من السحابة بالفعل. امسح بيانات اليوميات المتبقية من هذا الجهاز.',
  'Finish deletion': 'إكمال الحذف',
