...
export const ar: Translations = {
  ...
  'Cloud data is protected in transit and by your storage provider. Tackbok does not end-to-end encrypt cloud backups in this version.': 'تتم حماية البيانات السحابية أثناء النقل وبواسطة مزود التخزين. لا يوفر Tackbok تشفيرًا تامًا بين الطرفين للنسخ السحابية في هذا الإصدار.',
  ...
  'Google shares basic account identity so Tackbok can show a masked account label. Your email is never added to backups, logs, diagnostics, or analytics.': 'يشارك Google معلومات الحساب الأساسية كي يعرض Tackbok تسمية حساب مخفية. لا يُضاف بريدك الإلكتروني أبدًا إلى النسخ الاحتياطية أو السجلات أو التشخيصات أو التحليلات.',
  ...
  'This connects storage only. It does not create a Tackbok account.': 'هذا يربط التخزين فقط ولا ينشئ حساب Tackbok.',
