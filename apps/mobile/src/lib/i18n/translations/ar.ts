...
export const ar: Translations = {
  ...
  'Choose which copies of your journal to remove.': 'اختر نسخ يومياتك التي تريد إزالتها.',
  ...
  'Delete or reset data': 'حذف البيانات أو إعادة ضبطها',
  ...
  'Disconnect {provider} from this device?': 'هل تريد قطع اتصال {provider} بهذا الجهاز؟',
  ...
  'Journal text still syncs on mobile data.': 'تستمر مزامنة نص اليوميات عبر بيانات الهاتف.',
  ...
  'Sync media on Wi-Fi only': 'مزامنة الوسائط عبر Wi-Fi فقط',
