...
export const he: Translations = {
  ...
  'Cloud data is protected in transit and by your storage provider. Tackbok does not end-to-end encrypt cloud backups in this version.': 'הנתונים בענן מוגנים בהעברה ועל ידי ספק האחסון. בגרסה הזו Tackbok אינו מצפין גיבויי ענן מקצה לקצה.',
  ...
  'Google shares basic account identity so Tackbok can show a masked account label. Your email is never added to backups, logs, diagnostics, or analytics.': 'Google משתפת פרטי זהות בסיסיים כדי ש-Tackbok יציג תווית חשבון מוסתרת. כתובת האימייל שלך לעולם אינה מתווספת לגיבויים, ליומנים, לאבחון או לניתוח שימוש.',
  ...
  'This connects storage only. It does not create a Tackbok account.': 'הפעולה מחברת אחסון בלבד ואינה יוצרת חשבון Tackbok.',
