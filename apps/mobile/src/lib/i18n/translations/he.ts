...
export const he: Translations = {
  ...
  'Choose which copies of your journal to remove.': 'יש לבחור אילו עותקים של היומן להסיר.',
  ...
  'Delete or reset data': 'מחיקה או איפוס של נתונים',
  'Deleting journal everywhere…': 'מחיקת היומן מכל מקום…',
  'Removing the cloud backup and journal data. Keep Tackbok open.':
    'הגיבוי בענן ונתוני היומן נמחקים. יש להשאיר את Tackbok פתוח.',
  Disconnect: 'ניתוק',
  'Disconnect {provider}': 'ניתוק {provider}',
  'Disconnect {provider} from this device?': 'לנתק את {provider} מהמכשיר הזה?',
  ...
  'Journal text still syncs on mobile data.': 'טקסט היומן עדיין מסתנכרן דרך נתונים סלולריים.',
  ...
  'Sync media on Wi-Fi only': 'סנכרון מדיה ב-Wi-Fi בלבד',
  'Syncing…': 'מסנכרן…',
  ...
  'Finish deleting this journal?': 'להשלים את מחיקת היומן הזה?',
  'Cloud deletion is already recorded. Erase the remaining journal data from this device.': 'המחיקה מהענן כבר נרשמה. יש למחוק את נתוני היומן שנותרו במכשיר הזה.',
  'Finish deletion': 'השלמת המחיקה',
