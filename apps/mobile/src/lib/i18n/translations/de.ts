...
export const de: Translations = {
  ...
  'Backup health verified': 'Sicherungsstatus geprüft',
  'Before you connect': 'Vor dem Verbinden',
  'Check the cloud copy and repair if needed': 'Cloud-Kopie prüfen und bei Bedarf reparieren',
  ...
  'Cloud data is protected in transit and by your storage provider. Tackbok does not end-to-end encrypt cloud backups in this version.': 'Cloud-Daten sind bei der Übertragung und durch deinen Speicheranbieter geschützt. Tackbok verschlüsselt Cloud-Sicherungen in dieser Version nicht Ende-zu-Ende.',
  ...
  'Delete journal everywhere?': 'Tagebuch überall löschen?',
  Disconnect: 'Trennen',
  'Disconnect Google Drive?': 'Google Drive trennen?',
  'Disconnect provider': 'Anbieter trennen',
  ...
  'Google shares basic account identity so Tackbok can show a masked account label. Your email is never added to backups, logs, diagnostics, or analytics.': 'Google teilt grundlegende Kontodaten, damit Tackbok eine maskierte Kontobezeichnung anzeigen kann. Deine E-Mail wird nie Sicherungen, Protokollen, Diagnosen oder Analysen hinzugefügt.',
  ...
  'This connects storage only. It does not create a Tackbok account.': 'Dies verbindet nur den Speicher. Es wird kein Tackbok-Konto erstellt.',
  ...
  'Wi-Fi only for media': 'Medien nur über WLAN',
