...
export const zhTW: Translations = {
  ...
  'Backup health verified': '已驗證備份狀態',
  'Backup from {date}': '{date} 的備份',
  'Before you connect': '連線之前',
  'Check the cloud copy and repair if needed': '檢查雲端副本並在需要時修復',
  ...
  Disconnect: '中斷連線',
  'Disconnect Google Drive?': '中斷 Google Drive 連線？',
  'Disconnect provider': '中斷供應商連線',
  ...
  'This connects storage only—not a Tackbok account.': '這只會連接儲存空間，而不會建立 Tackbok 帳戶。',
  ...
  'Wi-Fi only for media': '媒體僅使用 Wi-Fi',
