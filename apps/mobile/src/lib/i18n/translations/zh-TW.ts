...
export const zhTW: Translations = {
  ...
  'Cloud data is protected in transit and by your storage provider. Tackbok does not end-to-end encrypt cloud backups in this version.': '雲端資料在傳輸過程中及由儲存空間供應商提供保護。此版本的 Tackbok 不會對雲端備份進行端對端加密。',
  ...
  'Google shares basic account identity so Tackbok can show a masked account label. Your email is never added to backups, logs, diagnostics, or analytics.': 'Google 會提供基本帳戶資訊，讓 Tackbok 顯示隱藏部分內容的帳戶標籤。你的電子郵件絕不會加入備份、記錄、診斷或分析資料。',
  ...
  'This connects storage only. It does not create a Tackbok account.': '這只會連接儲存空間，不會建立 Tackbok 帳戶。',
