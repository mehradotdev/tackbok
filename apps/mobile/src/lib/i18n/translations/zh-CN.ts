...
export const zhCN: Translations = {
  ...
  'Backup health verified': '已验证备份状态',
  'Backup from {date}': '{date} 的备份',
  'Before you connect': '连接之前',
  'Check the cloud copy and repair if needed': '检查云端副本并在需要时修复',
  ...
  Disconnect: '断开连接',
  'Disconnect Google Drive?': '断开 Google Drive？',
  ...
  'Syncing…': '正在同步…',
  'Text-only changes sync on mobile data. Changes with new photos or voice memos wait for Wi-Fi.': '仅文本更改会使用移动数据同步。包含新照片或语音备忘录的更改会等待 Wi-Fi。',
  ...
  'This connects storage only—not a Tackbok account.': '这只会连接存储空间，并不会创建 Tackbok 账户。',
  ...
  'Wi-Fi only for media': '媒体仅使用 Wi-Fi',
