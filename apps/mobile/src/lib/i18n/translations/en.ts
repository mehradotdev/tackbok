...
export const en = {
  ...
  FAQ: 'FAQ',
  'Read frequently asked questions': "Read Tackbok's frequently asked questions",
  ...
  'Read our terms and conditions': 'Read our terms & conditions',
  ...
  'Days journaled': 'Days journaled',
  Consistency: 'Consistency',
  Entries: 'Entries',
  Less: 'Less',
  More: 'More',
  'Your happiest day is {weekday}': 'Your happiest day is {weekday}',
  ...
  Evening: 'Evening',
  Night: 'Night',
  "You're a morning writer": 'You’re a morning writer',
  "You're an afternoon writer": 'You’re an afternoon writer',
  "You're an evening writer": 'You’re an evening writer',
  "You're a night writer": 'You’re a night writer',
  'Entries per month': 'Entries per month',
  'Top tags': 'Top tags',
  Totals: 'Totals',
  Words: 'Words',
  ...
  'One month ago today': 'One month ago today',
  '{count} years ago today': '{count} years ago today',
  'A moment from this day': 'A moment from this day',
