/** Original SkSL artwork: diffuse clouds, film grain and a sun/full moon.
...
half4 main(float2 xy) {
  ...
  if (distance < 1.03) {
    ...
    float3 lunar = light * shading * (0.74 + relief * 0.30);
  ...
  float2 wind = float2(drift * 0.32, drift * 0.06);
